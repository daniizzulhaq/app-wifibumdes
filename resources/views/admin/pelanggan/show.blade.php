...
<div class="breadcrumb">
    ...
    <a href="{{ route('admin.pelanggan.index') }}">Data Pelanggan</a>
    <span class="breadcrumb-separator">/</span>
    <span>Detail</span>
</div>
        ...
        <div class="info-card" style="margin-top: 24px;">
            ...
            <div class="card-body">
                <div class="info-row">
                    ...
                    <div class="info-value">
                        @if($pelanggan->paket)
                            <strong style="color: #111827; font-size: 16px;">{{ $pelanggan->paket->nama }}</strong>
                            <br>
                            <span style="color: #10b981; font-weight: 700; font-size: 15px;">
                                Rp {{ number_format($pelanggan->paket->harga, 0, ',', '.') }}/bulan
                            </span>
                            <br>
                            <small style="color: #6b7280;">
                                Kecepatan: {{ $pelanggan->paket->kecepatan }} | 
                                Kuota: {{ $pelanggan->paket->kuota }}
                            </small>
                        @else
                    ...
                    <div style="overflow-x: auto;">
                        <table class="tagihan-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>{{ \Carbon\Carbon::parse($tagihan->bulan . '-01')->format('F Y') }}</strong>
                                    </td>
                                    <td>
        ...
        <div class="info-card" style="margin-top: 24px;">
            ...
            <div class="card-body">
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <form action="{{ route('admin.pelanggan.update-status', $pelanggan->id) }}" method="POST">
                        @csrf
