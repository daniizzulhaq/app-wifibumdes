...
<div class="container-custom">
    ...
    <div style="margin-bottom: 20px;">
        <a href="{{ route('petugas.tagihan.index') }}" class="btn btn-secondary">
    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px;">
        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('petugas.tagihan.konfirmasi', $tagihan->id) }}" method="POST" style="margin-bottom: 10px;">
                        @csrf
...
<div class="modal" id="tolakModal" style="display: none;">
    <div class="modal-dialog">
        <form action="{{ route('petugas.tagihan.tolak', $tagihan->id) }}" method="POST">
            @csrf
